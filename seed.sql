...
(1, 1, 'Dupont', 'Marie', 'secretaire@getcet.fr', '$2y$10$l/BVFuoOyv661W6ETIqFzO6pEH4AmrSsocG4cM2/AoRO0Iznvl2Qi', '01 23 45 67 89', 'Mairie de Getcet', 0, 1, NOW());

-- Créer un compte bénévole de test
INSERT IGNORE INTO utilisateurs (id_utilisateur, id_role, nom, prenom, email, mot_de_passe, telephone, adresse, est_habitant, est_actif, created_at) VALUES
(2, 2, 'Martin', 'Pierre', 'benevole@getcet.fr', '$2y$10$l/BVFuoOyv661W6ETIqFzO6pEH4AmrSsocG4cM2/AoRO0Iznvl2Qi', '01 98 76 54 32', '15 rue des Bénévoles, Getcet', 0, 1, NOW());
